package com.A201844019.DelayCountWithDateKey;
...
public class DelayCountWithDateKey extends Configured implements Tool {
	...
	public int run(String[] arg0) throws Exception {  
		...
		MultipleOutputs.addNamedOutput(job, "departure", TextOutputFormat.class, DateKey.class, IntWritable.class); MultipleOutputs.addNamedOutput(job, "arrival", TextOutputFormat.class, DateKey.class, IntWritable.class);
